...
import com.jcoffee.commons.auth.util.AuthUtils;
import com.jcoffee.commons.basics.constant.SecurityConstants;
import com.jcoffee.commons.basics.model.Result;
import com.jcoffee.commons.basics.util.SpringUtil;
import com.jcoffee.database.auth.sys.entity.SysUser;
import com.jcoffee.oauth.authprovider.mobile.MobileAuthenticationToken;
import com.jcoffee.oauth.authprovider.openid.OpenIdAuthenticationToken;
import com.jcoffee.oauth.model.LoginAppUser;
import com.jcoffee.oauth.service.UserService;
import com.jcoffee.oauth.service.impl.RedisClientDetailsService;
...
//    }
    ...
    private ClientDetails getClient(String clientId, String clientSecret, RedisClientDetailsService clientDetailsService) {
        if (clientDetailsService == null) {
            clientDetailsService = redisClientDetailsService;
        }
